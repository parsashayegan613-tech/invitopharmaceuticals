export const faqs = [
    ...
    },
    {
        ...
        answer: "We understand academic and corporate purchasing workflows. We accept Institutional Purchase Orders (Net 30 terms), Wire Transfers, major Credit Cards, and PayPal to keep institutional procurement straightforward.",
    },
    {
        question: "Can you accommodate custom synthesis or bulk scale-up?",
        answer: "Yes. For industry partners or academic laboratories requiring larger quantities of Terrein or other specific microbial metabolites, please submit a custom RFQ. We work with partners to scope bulk purification workflows and scale-up timelines.",
    },
    {
        question: "Do you ship internationally?",
        answer: "Yes. We are based in Edmonton, Canada with typical 5-7 business day domestic delivery, and we routinely ship to research institutions in the US, Europe, and other international destinations. Lead times vary by destination.",
    },
    {
    ...
    },
    {
        ...
        answer: "No. All compounds provided by InVitvo Pharmaceuticals are strictly for Research Use Only (RUO). They are not intended for human, veterinary, diagnostic, or therapeutic use under any circumstances.",
    },
] as const;
